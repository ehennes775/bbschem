...
G_DEFINE_DYNAMIC_TYPE_EXTENDED(
    ...
    G_TYPE_OBJECT,
    0,
    G_IMPLEMENT_INTERFACE_DYNAMIC(BB_TYPE_GEDA_ITEM_FACTORY, bb_geda_box_factory_item_factory_init)
    )
...
static void
bb_geda_box_factory_class_finalize(BbGedaBoxFactoryClass *klasse)
{
}
...
{
    bb_geda_box_factory_register_type(module);
}
