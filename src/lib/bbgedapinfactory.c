...
G_DEFINE_TYPE_WITH_CODE(
    ...
    bb_geda_pin_factory,
    G_TYPE_OBJECT,
    G_IMPLEMENT_INTERFACE(BB_TYPE_GEDA_ITEM_FACTORY, bb_geda_pin_factory_item_factory_init)
    );
...
{
    return BB_SCHEMATIC_ITEM(bb_electrical_pin_new_with_params(params, error));
}
    ...
    )
{
    ...
    BbElectricalPin *pin = bb_electrical_pin_new_with_params(params, &local_error);
