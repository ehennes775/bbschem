...
bb_select_all_action_dispose(GObject *object)
{
    // BbSelectAllAction* privat = BbDelete_ACTION_GET_PRIVATE(object);
}
...
bb_select_all_action_get_name(GAction *action)
{
    const gchar *name = "edit-select-all";
...
bb_select_all_action_get_property(GObject *object, guint property_id, GValue *value, GParamSpec *pspec)
{
    switch (property_id)
    {
        ...
        case PROP_WINDOW:
            g_value_set_object(value, bb_select_all_action_get_window(BB_SELECT_ALL_ACTION(object)));
            break;
...
bb_select_all_action_register()
{
    bb_select_all_action_get_type();
}
...
bb_select_all_action_set_property(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
{
    ...
    {
        case PROP_WINDOW:
            bb_select_all_action_set_window(BB_SELECT_ALL_ACTION(object), g_value_get_object(value));
            break;
