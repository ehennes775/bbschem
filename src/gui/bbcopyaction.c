...
bb_copy_action_activate(GAction *action, GVariant *parameter)
{
    g_message("bb_copy_action_activate");
}
...
static void
bb_copy_action_init(BbCopyAction *window)
{
}
...
bb_copy_action_new()
{
    return BB_COPY_ACTION(g_object_new(BB_TYPE_COPY_ACTION, NULL));
}
