...
bb_select_tool_panel_create_tool(BbToolFactory *factory, BbToolSubject *subject);
...
bb_select_tool_panel_create_tool(BbToolFactory *factory, BbToolSubject *subject)
{
    return BB_DRAWING_TOOL(bb_select_tool_new(subject));
}
...
bb_select_tool_panel_register()
{
    bb_select_tool_panel_get_type();
}
...
bb_select_tool_panel_tool_factory_init(BbToolFactoryInterface *iface)
{
    ...
    iface->create_tool = bb_select_tool_panel_create_tool;
}
