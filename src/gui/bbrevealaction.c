...
BbDocumentWindow*
bb_reveal_action_get_subject(BbRevealAction *action);
...
void
bb_reveal_action_set_subject(BbRevealAction *action, BbDocumentWindow* subject);
...
bb_reveal_action_activate(GAction *action, GVariant *parameter)
{
    ...
    BbDocumentWindow *subject = bb_reveal_action_get_subject(BB_REVEAL_ACTION(action));

    g_return_if_fail(BB_IS_REVEAL_SUBJECT(subject));

    bb_reveal_subject_set_reveal(
        BB_REVEAL_SUBJECT(subject),
        !bb_reveal_subject_get_reveal(BB_REVEAL_SUBJECT(subject))
        );
}
...
bb_reveal_action_dispose(GObject *object)
{
    bb_reveal_action_set_subject(BB_REVEAL_ACTION(object), NULL);
}
...
bb_reveal_action_get_enabled(GAction *action)
{
    ...
    return BB_IS_REVEAL_SUBJECT(subject);
}
...
bb_reveal_action_get_property(GObject *object, guint property_id, GValue *value, GParamSpec *pspec)
{
    switch (property_id)
    {
        ...
        case PROP_SUBJECT:
            g_value_set_object(value, bb_reveal_action_get_subject(BB_REVEAL_ACTION(object)));
            break;
...
bb_reveal_action_get_state(GAction *action)
{
    ...
    return g_variant_ref(g_variant_new_boolean(
        BB_REVEAL_SUBJECT(subject) ? bb_reveal_subject_get_reveal(BB_REVEAL_SUBJECT(subject)) : FALSE
        ));
}
...
bb_reveal_action_set_property(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
{
    ...
    {
        case PROP_SUBJECT:
            bb_reveal_action_set_subject(BB_REVEAL_ACTION(object), g_value_get_object(value));
            break;
