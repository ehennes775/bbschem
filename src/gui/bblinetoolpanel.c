...
bb_line_tool_panel_select_tool(BbToolFactory *factory, BbDrawingToolSupport *support);
...
bb_line_tool_panel_select_tool(BbToolFactory *factory, BbDrawingToolSupport *support)
{
    return bb_drawing_tool_support_select_line_tool(support);
}
...
bb_line_tool_panel_tool_factory_init(BbToolFactoryInterface *iface)
{
    ...
    iface->select_tool = bb_line_tool_panel_select_tool;
}
