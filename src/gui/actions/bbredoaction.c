...
static void
bb_redo_action_generic_receiver_init(BbGenericReceiverInterface *iface);
...
G_DEFINE_TYPE_WITH_CODE(
    ...
    G_IMPLEMENT_INTERFACE(BB_TYPE_GENERIC_RECEIVER, bb_redo_action_generic_receiver_init)
    )
...
static GObject *
bb_redo_action_generic_receiver_get_receiver(BbGenericReceiver *object)
{
    return bb_redo_action_get_receiver(BB_REDO_ACTION(object));
}

static void
bb_redo_action_generic_receiver_set_receiver(BbGenericReceiver *object, GObject *receiver)
{
    bb_redo_action_set_receiver(BB_REDO_ACTION(object), receiver);
}
...
bb_redo_action_generic_receiver_init(BbGenericReceiverInterface *iface)
{
    ...
    iface->get_receiver = bb_redo_action_generic_receiver_get_receiver;
    iface->set_receiver = bb_redo_action_generic_receiver_set_receiver;
}
...
static void
bb_copy_action_notify_can_redo(GObject *unused, GParamSpec *pspec, GObject *action)
{
    ...
    if (action->receiver != receiver)
    {
        ...
        if (action->receiver != NULL)
        {
            ...
            g_signal_connect(
                receiver,
                "notify::can-redo",
                G_CALLBACK(bb_copy_action_notify_can_redo),
                action
                );
        }
