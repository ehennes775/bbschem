...
static void
bb_select_none_action_generic_receiver_init(BbGenericReceiverInterface *iface);
...
G_DEFINE_TYPE_WITH_CODE(
    ...
    G_IMPLEMENT_INTERFACE(BB_TYPE_GENERIC_RECEIVER, bb_select_none_action_generic_receiver_init)
    )

// region From BbGenericReceiver interface

static GObject *
bb_select_none_action_generic_receiver_get_receiver(BbGenericReceiver *object)
{
    return bb_select_none_action_get_receiver(BB_SELECT_NONE_ACTION(object));
}

static void
bb_select_none_action_generic_receiver_set_receiver(BbGenericReceiver *object, GObject *receiver)
{
    bb_select_none_action_set_receiver(BB_SELECT_NONE_ACTION(object), receiver);
}
...
bb_select_none_action_generic_receiver_init(BbGenericReceiverInterface *iface)
{
    ...
    iface->get_receiver = bb_select_none_action_generic_receiver_get_receiver;
    iface->set_receiver = bb_select_none_action_generic_receiver_set_receiver;
}
...
bb_select_none_action_activate(GAction *action, GVariant *parameter)
{
    GObject *receiver = bb_select_none_action_get_receiver(BB_SELECT_NONE_ACTION(action));

    if (BB_IS_SELECT_RECEIVER(receiver))
    {
        bb_select_receiver_select_none(BB_SELECT_RECEIVER(receiver));
    }
}
...
bb_select_none_action_dispose(GObject *object)
{
    BbSelectNoneAction *action = BB_SELECT_NONE_ACTION(object);

    g_return_if_fail(action != NULL);

    bb_select_none_action_set_receiver(action, NULL);

    G_OBJECT_GET_CLASS(bb_select_none_action_parent_class)->dispose(object);
}
...
bb_select_none_action_get_enabled(GAction *action)
{
    ...
    return
        ...
        bb_select_receiver_can_select_none(BB_SELECT_RECEIVER(receiver));
}
...
bb_select_none_action_get_property(GObject *object, guint property_id, GValue *value, GParamSpec *pspec)
{
    switch (property_id)
    {
        ...
        case PROP_RECEIVER:
            g_value_set_object(value, bb_select_none_action_get_receiver(BB_SELECT_NONE_ACTION(object)));
            break;
...
GObject*
bb_select_none_action_get_receiver(BbSelectNoneAction *action)
{
    g_return_val_if_fail(action != NULL, NULL);
...
bb_select_none_action_set_property(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
{
    ...
    {
        case PROP_RECEIVER:
            bb_select_none_action_set_receiver(BB_SELECT_NONE_ACTION(object), g_value_get_object(value));
            break;
...
void
bb_select_none_action_set_receiver(BbSelectNoneAction *action, GObject* receiver)
{
    g_return_if_fail(action != NULL);
