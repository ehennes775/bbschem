...
G_DECLARE_INTERFACE(${modulePascalCase}${classPascalCase}, ${moduleLowerSnake}_${classLowerSnake}, ${moduleUpperSnake}, ${classUpperSnake}, ${basePascalCase})

struct _${modulePascalCase}${classPascalCase}Interface
{
